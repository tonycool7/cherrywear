...
<div class="container user">
	<div class="row">
		<div class="col-md-4">
			<h3>Здравствуйте, !</h3>
			<p>Приветствуем Вас! Это — ваша персональная инфопанель {{config('app.name')}}, где Вы можете обновить Ваши персональные данные и платежные реквизиты, а также просмотреть информацию о Ваших заказах</p>
		</div>
		<div class="col-md-8">
			<h3>ЗАКАЗЫ</h3>
